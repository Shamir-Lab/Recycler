...
Assuming we have prepared a filtered BAM file (aln-pe.bam) prepared as described [below](#bam-prep) and an isolate assembly graph (assem.fastg), and that 55 was the maximum k-mer length used by the assembler, 

    git clone https://github.com/rozovr/Recycler.git
    cd Recycler
    python recycle.py -g assem.fastg -k 55 -b aln-pe.bam -i True
